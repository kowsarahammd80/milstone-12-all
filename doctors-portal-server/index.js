...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.df9nipl.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  ...
  try {
    ...
    app.get('/appointmentOptions', async (req, res) => {
      ...
      // code carefully bcoz filter the appointment date 
      options.forEach(option => {
        ...
        console.log(optionBooked, remainigSlots.length)
      })
    ...
    // advance lvl get optional uoprer tar alternative but advance
